...
import { EXERCISES } from "../utils/generate";

export default function ExerciseCard(props) {
  const { exercise, i } = props;
  // return(
  //     <div>  <div>ExerciseCard</div>
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center gap-x-4">
        ...
        <h2 className="capitalze whitespace-nowrap truncate max-w-full text-lg sm:text-xl md:text-2xl flex-1 md:text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:border-red-600 w-full  duration-200"
        >
